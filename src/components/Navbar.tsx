...
export default function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-40 border-b border-white/[0.07] bg-[#060712]/75 backdrop-blur-2xl">
            <div className="mx-auto flex h-[70px] w-full max-w-[1500px] items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2 rounded-xl border border-white/[0.08] bg-white/[0.035] py-1 pl-1 pr-2.5 shadow-[inset_0_1px_0_rgba(255,255,255,.04)]">
